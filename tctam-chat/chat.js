...
firebase.auth().onAuthStateChanged((user) => {
    if (user && user.emailVerified) {
        ...
        notification("Verifieer uw e-mail om berichten te verzenden. Ga naar <a href='https://tctam.nl/account/'>uw profiel</a> om de mail te ontvangen. <br>Reload na het Verifieren de pagina.");
    }
});
...
database.ref('chat').orderByChild('timestamp').limitToLast(300).on('child_added', (snapshot) => {
    ...
    deleteButton.style.right = '-30px'; // Add this line
